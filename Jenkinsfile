pipeline {
    ...
    environment {
        ...
        AEROSPIKE_CUSTOM_INIT_NAME_TAG="aerospike-kubernetes-init:2.5.1"
    }
                    ...
                    steps {
                        script {
                           dir("${env.GO_REPO}") {
                               ...
                               sh "./snyk-linux container test ${OPERATOR_CONTAINER_IMAGE_CANDIDATE_NAME} --severity-threshold=high --file=Dockerfile --policy-path=.snyk  || true"
