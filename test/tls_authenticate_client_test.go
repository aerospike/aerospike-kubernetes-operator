...
var _ = Describe("TlsAuthenticateClient", func() {
	ctx := goctx.TODO()
	Context("When using tls-authenticate-client: Any", func() {
		doTestTLSAuthenticateClientAny(ctx)
	})
	Context("When using tls-authenticate-client: Empty String", func() {
		doTestTLSAuthenticateClientEmptyString(ctx)
	})
	Context("When using tls-authenticate-client: TLS name missing", func() {
		doTestTLSNameMissing(ctx)
	})
	Context("When using tls-authenticate-client: TLS config missing", func() {
		doTestTLSMissing(ctx)
	})
	Context("When using tls-authenticate-client: OperatorClientCertSpec missing", func() {
		doTestOperatorClientCertSpecMissing(ctx)
	})
	Context("When using tls-authenticate-client: specified random string", func() {
		doTestTLSAuthenticateClientRandomString(ctx)
	})
	Context("When using tls-authenticate-client: Domain List", func() {
		doTestTLSAuthenticateClientDomainList(ctx)
	})

	Context("When using tls-authenticate-client: Client Name Missing", func() {
		doTestTlsClientNameMissing(ctx)
	})
	Context("When using tls-authenticate-client: False", func() {
...
func doTestTLSAuthenticateClientAny(ctx goctx.Context) {
	...
	It("TlsAuthenticateClientAny", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
		...
		aeroCluster := getAerospikeConfig(networkConf, operatorClientCertSpec)
...
func doTestTLSAuthenticateClientEmptyString(ctx goctx.Context) {
	...
	It("TlsAuthenticateClientEmptyString", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
				"tls-name":                "aerospike-a-0.test-runner",
...
func doTestOperatorClientCertSpecMissing(ctx goctx.Context) {
	...
	It("OperatorClientCertSpecMissing", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
				"tls-name":                "aerospike-a-0.test-runner",
				"tls-authenticate-client": "any",
		...
		err := aerospikeClusterCreateUpdate(k8sClient, aeroCluster, ctx)
		if !strings.Contains(err.Error(), "operator client cert is not specified") {
...
func doTestTLSAuthenticateClientRandomString(ctx goctx.Context) {
	...
	It("TLSAuthenticateClientRandomString", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
				"tls-name":                "aerospike-a-0.test-runner",
...
func doTestTLSAuthenticateClientDomainList(ctx goctx.Context) {
	...
	It("TlsAuthenticateClientDomainList", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
				"tls-name":                "aerospike-a-0.test-runner",
		...
		Expect(reflect.DeepEqual([]string{"aerospike-a-0.test-runner", "aerospike-a-0.tls-client-name"},
			tlsAuthenticateClient)).To(BeTrue(),
			"TlsAuthenticateClientAny Validation Failed")
...
func doTestTlsClientNameMissing(ctx goctx.Context) {
	...
	It("TlsClientNameMissing", func() {
		...
		aeroCluster := getAerospikeConfig(networkConf, operatorClientCertSpec)
		err := aerospikeClusterCreateUpdate(k8sClient, aeroCluster, ctx)
		if !strings.Contains(err.Error(), "operator TLSClientName is not specified") {
			Fail("operator client cert is not specified")
		}
		deleteCluster(k8sClient, ctx, aeroCluster)
	})
...
func doTestTLSAuthenticateClientFalse(ctx goctx.Context) {
	...
	It("TlsAuthenticateClientFalse", func() {
		networkConf := map[string]interface{}{
			"service": map[string]interface{}{
				"tls-name":                "aerospike-a-0.test-runner",
