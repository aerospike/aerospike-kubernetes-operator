...
func DeployClusterForAllImagesPost570(ctx goctx.Context) {
	versions := []string{
		"8.1.0.0", "8.0.0.2", "7.2.0.6", "7.1.0.12", "7.0.0.20", "6.4.0.7", "6.3.0.13", "6.2.0.9", "6.1.0.14", "6.0.0.16",
	}
...
// Webhook update validation tests moved to
// test/envtests/cluster/cluster_webhook_test.go (negativeUpdateClusterValidationTest).
