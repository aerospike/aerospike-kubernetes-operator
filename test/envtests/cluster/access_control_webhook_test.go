			...
			Context("negative", func() {
				...
				DescribeTable("fails on invalid custom role name",
					...
					Entry("exceeds max length", strings.Repeat("a", 64),
						[]string{"aerospikeAccessControl.roles", "63", testutil.CRDSchemaErrorPrefix}),
		...
		Context("spec.aerospikeAccessControl (users)", func() {
			Context("negative", func() {
				...
				DescribeTable("fails on invalid username",
					...
					Entry("exceeds max length", strings.Repeat("u", 64), []string{"aerospikeAccessControl.users", "63",
						testutil.CRDSchemaErrorPrefix}),
