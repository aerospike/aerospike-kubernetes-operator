...
// func AerospikeAdminCredentials(desiredState *AerospikeClusterSpec, currentState *AerospikeClusterSpec, passwordProvider AerospikeUserPasswordProvider) (string, string, error) {
...
// func ReconcileAccessControl(desired *AerospikeClusterSpec, current *AerospikeClusterSpec, client *as.Client, passwordProvider AerospikeUserPasswordProvider, logger Logger) error {
...
// func GetAdminPolicy(clusterSpec *AerospikeClusterSpec) as.AdminPolicy {
...
// func reconcileRoles(desired map[string]AerospikeRoleSpec, current map[string]AerospikeRoleSpec, client *as.Client, adminPolicy as.AdminPolicy, logger Logger) error {
...
// func reconcileUsers(desired map[string]AerospikeUserSpec, current map[string]AerospikeUserSpec, passwordProvider AerospikeUserPasswordProvider, client *as.Client, adminPolicy as.AdminPolicy, logger Logger) error {
...
// 	Get(username string, userSpec *AerospikeUserSpec) (string, error)
// }
