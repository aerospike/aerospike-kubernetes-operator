...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CaCertPath) DeepCopyInto(out *CaCertPath) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CaCertPath.
func (in *CaCertPath) DeepCopy() *CaCertPath {
	if in == nil {
		return nil
	}
	out := new(CaCertPath)
