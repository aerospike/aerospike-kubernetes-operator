...
func (in *BackupRoutine) DeepCopyInto(out *BackupRoutine) {
	*out = *in
	in.BackupRoutine.DeepCopyInto(&out.BackupRoutine)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupRoutine.
...
func (in *RestoreConfig) DeepCopyInto(out *RestoreConfig) {
	*out = *in
	if in.RestoreRequest != nil {
		in, out := &in.RestoreRequest, &out.RestoreRequest
		*out = (*in).DeepCopy()
	}
}
