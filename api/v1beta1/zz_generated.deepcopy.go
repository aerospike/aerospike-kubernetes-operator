...
func (in *AerospikeBackupSpec) DeepCopyInto(out *AerospikeBackupSpec) {
	*out = *in
	if in.BackupService != nil {
		in, out := &in.BackupService, &out.BackupService
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnDemand) DeepCopyInto(out *OnDemand) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnDemand.
func (in *OnDemand) DeepCopy() *OnDemand {
	if in == nil {
		return nil
	}
	out := new(OnDemand)
