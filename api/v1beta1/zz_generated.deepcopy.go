...
func (in *BackupConfig) DeepCopyInto(out *BackupConfig) {
	*out = *in
	if in.AerospikeCluster != nil {
		in, out := &in.AerospikeCluster, &out.AerospikeCluster
		*out = new(Cluster)
		(*in).DeepCopyInto(*out)
	}
	if in.Storage != nil {
		in, out := &in.Storage, &out.Storage
		*out = make(map[string]*model.Storage, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
	}
	if in.BackupRoutines != nil {
		in, out := &in.BackupRoutines, &out.BackupRoutines
		*out = make(map[string]*model.BackupRoutine, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
	}
	if in.BackupPolicies != nil {
		...
		*out = make(map[string]*model.BackupPolicy, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
	}
...
func (in *Cluster) DeepCopyInto(out *Cluster) {
	*out = *in
	in.AerospikeCluster.DeepCopyInto(&out.AerospikeCluster)
}
...
func (in *RestoreConfig) DeepCopyInto(out *RestoreConfig) {
	*out = *in
	in.RestoreRequest.DeepCopyInto(&out.RestoreRequest)
}
