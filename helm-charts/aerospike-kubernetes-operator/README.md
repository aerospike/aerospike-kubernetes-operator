...
| `operatorImage.tag`                 | Operator image tag                                                                                                                                                                                              | `4.2.0-dev1`                                                                                                      |
...
| `enableSafePodEviction`             | Enables eviction webhook to block Aerospike pod evictions during node maintenance. Also enables Prometheus metrics (`aerospike_ako_eviction_webhook_requests_total` with labels: eviction_namespace, decision). | `false`                                                                                                           |
