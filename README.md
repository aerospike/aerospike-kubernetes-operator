...
aerospike-kubernetes-operator.v2.1.0-74b946466d                 ClusterRole/aerospike-kubernetes-operator.v2.1.0-74b946466d   41m
```

In the example above the name of the cluster role binding is `aerospike-kubernetes-operator.v2.1.0-74b946466d`

Edit the role binding and add a new subject entry for the service account

```shell
# Replace aerospike-kubernetes-operator.v2.1.0-5-dev-74b946466d with the name of the cluster role binding found above
kubectl edit clusterrolebindings.rbac.authorization.k8s.io  aerospike-kubernetes-operator.v2.1.0-5-dev-74b946466d
```
...
metadata:
  ...
  labels:
    olm.owner: aerospike-kubernetes-operator.v2.1.0-5-dev
    olm.owner.kind: ClusterServiceVersion
    olm.owner.namespace: test
    operators.coreos.com/aerospike-kubernetes-operator.test: ""
  name: aerospike-kubernetes-operator.v2.1.0-5-dev-74b946466d
